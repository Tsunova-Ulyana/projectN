    ...
    <div class="area">
        <div class="inscription">
            <div class="image-wrapper">
                <img src="./images/icons8-пользователь-мужчина-в-кружке-60.png" alt="">
            </div>
            <h1>Вход</h1>
        </div>
        <div class="input_area">
            <div class="login">
                <input name="login" type="text" name="login" placeholder="Логин">
            </div>
            <div class="password">
                <input name="password" type="password" name="password" placeholder="Пароль">
            </div>
         </div>
         <button class="testknopka">Войти</button> 
    <div class="ssylka">
         <a href="./registration.php">Нет аккаунта? Зарегистрируйтесь прямо сейчас!</a> 
    </div>
    </div>
    </form>
