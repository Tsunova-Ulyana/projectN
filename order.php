...
$query = $pdo->prepare("SELECT * FROM ordered_products
JOIN orders on ordered_products.Id_Order=orders.Id_Order
JOIN products on products.Id_Product=ordered_products.Id_Product
...
<?= require_once('./ComponentHeader.php') ;?>
        ...
        <section class="cart">
            <div class="container">
                <h2 class="H2 cart-title">Заказ №<?=  $_GET['order'];?></h2>
